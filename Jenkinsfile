...
stages{
  ...
  stage("deploy-test"){
    steps{
      ...
      sh """
      scp -o StrictHostKeyChecking=no /home/ec2-user/apache-maven-3.8.2/web-project/target/*.war myweb.war ec2-user@18.234.161.177:/home/ec2-user/apache-tomcat-10.0.11/webapps
